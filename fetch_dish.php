<?php
session_start();
include 'connection/connect.php'; // make sure this connects to your DB
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        <div class="d-flex align-items-center">
                            <input class="form-control form-control-sm me-2" type="number" name="quantity" value="1" min="1"
                                style="width: 100px;">
