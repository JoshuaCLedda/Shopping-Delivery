                                    ...
                                    if (!mysqli_num_rows($query) > 0) {
                                        ...
                                        while ($rows = mysqli_fetch_array($query)) {
                                            echo '<tr>
                                                        ...
                                                        <td>' . htmlspecialchars($rows['restaurant_name']) . '</td>
                                                        <td class="status-cell">' . htmlspecialchars($rows['status']) . '</td>
...
$(document).ready(function () {
    $(".view-details-btn").click(function () {
        ...
        $.ajax({
            url: "get_order_details.php", // PHP file to fetch order details
            type: "GET",
            data: { trans_id: transId },
            success: function (response) {
                $('#userDetailsContent').html(response); // Display order details in modal
