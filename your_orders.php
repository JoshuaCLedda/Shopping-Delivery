                        ...
                        <div class="order-card p-4 mb-4 order-item" data-status="<?php echo $status; ?>">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-end d-flex flex-column gap-2">
                                    ...
                                    <?php if ($status !== 'Delivered' && $status !== 'Order_Cancelled') : ?>
                                        <?php if (!empty($rider_id) && $rider_id != 0) : ?>

                                            <?php if ($status === 'order_received') : ?>
                                                <!-- Already marked received -->
                                                <button class="btn btn-success btn-sm" disabled>Order Already Received</button>
                                        ...
                                        <?php if ($status !== 'order_received' && $status !== 'order_delivered') : ?>
                                            <!-- Show cancel option only if not received or delivered -->
