                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="delete_menu.php?menu_del=' . $rows['d_id'] . '" class="btn btn-danger btn-flat btn-xs m-b-10">
                                                                    <i class="fa fa-trash-o" style="font-size:16px"></i>
                                                                </a> 
                                                                <a href="update_menu.php?menu_upd=' . $rows['d_id'] . '" class="btn btn-info btn-flat btn-xs m-b-10">
